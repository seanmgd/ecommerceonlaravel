                    ...
                    <form class="cart flex flex-col" action="{{ route('cart.store') }}" method="post">
                            ...
                            <div class="variation_form_section">
                                <div class="product-options icons-lg">
                                    <div class="select-option swatch-wrapper">
                                        <a href="#" id="S" title="Medium" class="swatch-anchor flex items-center justify-center">
                                            S
                                        </a>
                                    </div>
                                    <div class="select-option swatch-wrapper">
                                        <a href="#" id="M" title="Small" class="swatch-anchor flex items-center justify-center">
                                            M
                                        </a>
                                    </div>
                                    <div class="select-option swatch-wrapper">
                                        <a href="#" id="L" title="Extra Large" class="swatch-anchor flex items-center justify-center">
                                            L
                                        </a>
                                    </div>
                                    <div class="select-option swatch-wrapper">
                                        <a href="#" id="XL" title="Extra Extra Large" class="swatch-anchor flex items-center justify-center">
                                            XL
                                        </a>
                                    </div>
                                </div>
                        ...
                        <div class="single_variation_wrap">
                            <div class="variations_button">
                                <div class="quantity">
                                    <input type="number" name="qty" value="1" title="Qty" class="input-text qty text" min="1">
                                </div>
