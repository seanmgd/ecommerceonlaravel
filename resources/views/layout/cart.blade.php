                                ...
                                <form>
                                    <td class="product-thumbnail hidden-xs">
                                        <a href="{{ route('product', $product->model->slug) }}">
                                            <img width="100" height="150"
                                                 src="{{ Voyager::image($product->model->image) }}" alt="Product-1"
                                                 class="mt-1"/>
                                        </a>
                                    </td>
                                    ...
                                    <td class="product-quantity text-center">
                                        <div class="quantity flex justify-center">
                                            <input type="number" step="1" min="0" name="qty" value="{{ $product->qty }}"
                                                   title="Qty" class="input-text qty text" size="4"/>
                                        </div>
                                    </td>
                                    <td class="product-subtotal hidden-xs text-center">
                                        <span class="amount">{{ $product->model->price * $product->qty}} €</span>
                                    </td>
                    ...
                    <div class="cart-collaterals pt-16">
                        <div class="cart_totals">
                            ...
                            <table>
                                ...
                                <tr>
                                    <th>Total</th>
                                    <td><strong><span class="amount">{{number_format(Cart::subtotal() + 8, 2)}} €</span></strong>
                                    </td>
                                </tr>
                            </table>
                            <div class="wc-proceed-to-checkout">
                                <a href="{{route('checkout.index')}}" class="checkout-button button alt wc-forward">Proceed
                                    to Checkout</a>
                            </div>
                        </div>
